...
export const onDragNode: IOnDragNode = ({ config, event, data, id }) => (
  chart: IChart
) => {
...
export const onDragCanvas: IOnDragCanvas = ({ config, event, data }) => (
  chart: IChart
): IChart => {
  chart.offset =
    config && config.snapToGrid
...
export const onLinkStart: IOnLinkStart = ({
  linkId,
  fromNodeId,
  fromPortId
}) => (chart: IChart): IChart => {
...
export const onLinkMouseEnter: IOnLinkMouseEnter = ({ linkId }) => (
  chart: IChart
) => {
...
export const onLinkMouseLeave: IOnLinkMouseLeave = ({ linkId }) => (
  chart: IChart
) => {
  const link = chart.links[linkId];
  // Set the connected ports to hover
...
export const onLinkClick: IOnLinkMouseLeave = ({ linkId }) => (
  chart: IChart
) => {
